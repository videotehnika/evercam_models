defmodule Evercam.Types.MACADDR do
  @moduledoc ~S"""
...
defimpl String.Chars, for: Postgrex.MACADDR do
  def to_string(%Postgrex.MACADDR{}=address), do: Evercam.Types.MACADDR.decode(address)
end

if Code.ensure_loaded?(Phoenix.HTML) do
  defimpl Phoenix.HTML.Safe, for: Postgrex.MACADDR do
    def to_iodata(%Postgrex.MACADDR{}=address), do: Evercam.Types.MACADDR.decode(address)
  end
end
